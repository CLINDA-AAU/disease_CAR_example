...
![](README_files/figure-gfm/datamanagement-1.png)<!-- -->
...
```
    ...
    ## The current progress of the model fitting algorithm has been output to CARBayesprogress.txt in the working directory
    ## Summarising results.
